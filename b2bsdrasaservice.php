    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 d-flex justify-content-center">
            <div class="card text-center shadow position-relative" 
                ...
                <div class="position-absolute top-0 start-50 translate-middle badge bg-primary rounded-circle p-2" 
                     style="width: 30px; height: 30px; font-size: 14px; display: flex; align-items: center; justify-content: center;">
                    1
                </div>
        ...
        <!-- Card 2 -->
        <div class="col-lg-2 col-md-4 col-sm-6 d-flex justify-content-center">
            <div class="card mt-2 text-center shadow position-relative" 
                 style="width: 200px; height: 170px; border: 1px solid #ccc;">
                <div class="position-absolute top-0 start-50 translate-middle badge bg-primary rounded-circle p-2" 
                     style="width: 30px; height: 30px; font-size: 14px; display: flex; align-items: center; justify-content: center;">
                    2
