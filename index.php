    ...
    <div class="container py-5">
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="feature-item p-4 pt-0">
                    <div class="feature-img p-4 mb-4">
                        <img src="img/b2bleadgeneration.jpeg" class="img-fluid zoom-effect" alt="B2B Lead Generation">
                    </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                <div class="feature-item p-4 pt-0">
                    <div class="feature-img p-4 mb-4">
                        <img src="img/adverb2b.jpeg" class="img-fluid zoom-effect" alt="B2B Advertising">
                    </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="feature-item p-4 pt-0">
                    <div class="feature-img p-4 mb-4">
                        <img src="img/b2bsdrasaservice.jpeg" class="img-fluid zoom-effect" alt="B2B SDR as a Service">
                    </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                <div class="feature-item p-4 pt-0">
                    <div class="feature-img p-4 mb-4">
                        <img src="img/contentsyndication.jpeg" class="img-fluid zoom-effect" alt="Content Syndication">
                    </div>
        ...
        <a class="btn btn-dark rounded-pill py-3 px-5" href="feature.php">View More Services</a>
        </div>
    </div> 
</div>
                ...
                <div class="row g-5">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-item-content bg-white rounded p-5 h-100">
                            ...
                            <p>RDIGS was founded by a team of experienced professionals, each with over 15 years in sales and B2B lead generation. Recognizing a key gap in the market, they set out with a mission to address it head-on. While driven by technology, RDIGS values the human touch, ensuring each client benefits from a personalized experience
                            </p>
                            ...
                            <p class="text-dark mb-4"><i class="fa fa-check text-primary me-3"></i>Personalized Experience</p>
                            ...
                            <div class="row g-4 justify-content-center">
                                <div class="col-12">
                                    <div class="rounded bg-white">
                                        <img src="img/about-1.png" class="img-fluid rounded w-64" alt="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
