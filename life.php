    ...
    <div class="container py-5">
            ...
            <div class="container pb-5">
                <div class="row g-5">
                    ...
                    <div class="image-grid">
                        ...
                        <img src="img/2.webp" class="grid-img" alt="Teamwork at RDIGS">
                        <img src="img/3.webp" class="grid-img" alt="RDIGS Events">
                        <img src="img/4.webp" class="grid-img" alt="Work Culture">
                        <img src="img/5.webp" class="grid-img" alt="Fun at RDIGS">
                        <img src="img/6.webp" class="grid-img" alt="Success Stories">
                        <img src="img/7.webp" class="grid-img" alt="Innovation">
                        <img src="img/8.webp" class="grid-img" alt="Growth">
                        <img src="img/9.webp" class="grid-img" alt="Team Spirit">
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-2">
                <img src="img/e1.webp" class="img-fluid rounded shadow" style="width:100%; height:auto;">
                <h5 style="margin-top: 10px; font-weight: bold;">Team Outing 2023</h5>
            </div>
            <!-- Image 2 -->
            <div class="col-6 col-md-4 col-lg-2">
                <img src="img/e2.webp" class="img-fluid rounded shadow" style="width:100%; height:auto;">
                <h5 style="margin-top: 10px; font-weight: bold;">Trip 2023</h5>
            </div>
            <!-- Image 3 -->
            <div class="col-6 col-md-4 col-lg-2">
                <img src="img/e3.webp" class="img-fluid rounded shadow" style="width:100%; height:auto;">
                <h5 style="margin-top: 10px; font-weight: bold;">Annual Day 2023</h5>
            </div>
            <!-- Image 4 -->
            <div class="col-6 col-md-4 col-lg-2">
                <img src="img/e4.webp" class="img-fluid rounded shadow" style="width:100%; height:auto;">
                <h5 style="margin-top: 10px; font-weight: bold;">Independence Day 2023</h5>
            </div>
            <!-- Image 5 -->
            <div class="col-6 col-md-4 col-lg-2">
                <img src="img/e5.webp" class="img-fluid rounded shadow" style="width:100%; height:auto;">
                <h5 style="margin-top: 10px; font-weight: bold;">Women's Day 2023</h5>
            </div>
            <!-- Image 6 -->
            <div class="col-6 col-md-4 col-lg-2">
                <img src="img/e6.webp" class="img-fluid rounded shadow" style="width:100%; height:auto">
